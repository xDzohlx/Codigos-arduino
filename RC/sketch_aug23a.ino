...
//Serial.println("centro 1:");
//Serial.print(motor_izquierda_centro);
//TCCR0A &= ~(1<<COM0A0);
//TCCR0A = (1<<COM0A1);
//TCCR0A &= ~(1<<COM0B0);
//TCCR0A = (1<<COM0B1);
//TCCR0 = (1<<C0M01)|(1<<C0M00);
...
//Serial.println("centro 2:");
//Serial.print(motor_derecha_centro);
//delay(5000);
}
...
void loop() {
    ...
    //Serial.println(canal_1);
    //canal_1 /= 1000;

    
    //Serial.print("Camal 2");
    //Serial.println(canal_1);
